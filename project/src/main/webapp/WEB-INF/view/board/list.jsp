			...
			<tr>
				...
				<c:forEach var="board" items="${boardlist}">
					<tr>
						...
						<td><c:if
								test='${board.name.equals(sessionScope.loginUser.name) || board.name.equals("관리자")}'>
					${board.name}
				</c:if> <c:if
								test='${!board.name.equals(sessionScope.loginUser.name) && !board.name.equals("관리자")}'>
								<a href="#profileInfo" class="open-profileInfoModal"
									data-toggle="modal" data-name="${board.name}">${board.name}</a>
							</c:if></td>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-4">
								...
								<span class="modal-font">포트폴리오</span>
								</a>
							</div>
							<div class="col-md-4">
								...
								<span class="modal-font">쪽지보내기</span>
								</a>
							</div>
							<div class="col-md-4">
								...
								<span class="modal-font">신고하기</span>
								</a>
							</div>
						</div>
					</div>
